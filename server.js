...
const connection = mysql.createConnection({
  ...
  // Put in your MySQL password above if you want to change it to your own
...
connection.connect(function(err) {
    ...
    console.log ("======================================");
    console.log ("");
    console.log ("   CJ'S EMPLOYEE TRACKER   ");
    console.log ("");
    console.log ("======================================");
    runEmployeeDB();
  });
    ...
    choices: [
        ...
        switch (answers.action) {
            ...
            case "Exit":
                console.log ("===============================================");
                console.log ("");
                console.log ("   THANK YOU FOR USING CJ'S EMPLOYEE TRACKER   ");
                console.log ("");
                console.log ("===============================================");
                connection.end();
            break;
...
function viewEmployeesByRole() {
  ...
  if (err) throw err
  console.log ("");
  console.log("*** LIST OF EMPLOYEES BY ROLE ***")
  console.log ("");
  console.table(res)
  runEmployeeDB()
  })
